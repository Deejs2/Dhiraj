...
<div class="container">
    ...
    <header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
      <a href="/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-dark text-decoration-none">
        <img class="bi me-2" src="img/me-falvicon.JPG" width="40" height="40" style="border-radius: 20px;"></img>
        <span class="fs-4" style="font-family: cursive;">Dhiraj</span>
      </a>

      <ul class="nav nav-pills">
        <li class="nav-item"><a href="?page=home" class="nav-link">Home</a></li>
        <li class="nav-item"><a href="?page=feature" class="nav-link">Features</a></li>
