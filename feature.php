...
<div class="container px-4 py-5">
  ...
  <main>
    <div class="text-center">
        ...
        <p class="text-muted">Hire Me!</p>
    </div>
    <div class="row row-cols-1 row-cols-md-3 mb-3 text-center" style="display:flex; justify-content:center;">
      <div class="col">
        <div class="card mb-4 rounded-3 shadow-sm border-primary">
          <div class="card-header py-3 text-bg-primary border-primary">
            <h4 class="my-0 fw-normal">Static Website</h4>
          </div>
          <div class="card-body">
            <h1 class="card-title pricing-card-title">NRs: 500-2000</h1><p class="text-muted fw-light">One Time Payment</p>
            <ul class="list-unstyled mt-3 mb-4">
              <li>.np Domain(Registration & Activation)</li>
              <li>Github(Hosting)</li>
              <li>Cloudfare support</li>
              <li>Photographic website, portfolie, Personal Blog and more!</li>
            </ul>
            <a href="?page=contact"><button type="button" class="w-100 btn btn-lg btn-outline-primary">Contact Us</button></a>
          </div>
        </div>
      </div>
    </div>
